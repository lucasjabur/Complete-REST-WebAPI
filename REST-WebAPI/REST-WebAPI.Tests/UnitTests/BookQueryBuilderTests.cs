...
namespace REST_WebAPI.Tests.UnitTests {
    public class BookQueryBuilderTests {
        ...
        public void BuildQueries_ShouldReturnCorrectQueries() {
            ...
            // Act
            var (query, countQuery, sort, size, offset) = _queryBuilder.BuildQueries(title, sortDirection, pageSize, page);
            ...
            query.Should().Contain("FROM dbo.books");
            query.Should().Contain("WHERE");
            query.Should().Contain("Code");
            ...
            countQuery.Should().Contain("FROM dbo.books");
            countQuery.Should().Contain("WHERE");
            countQuery.Should().Contain("Code");
        }
